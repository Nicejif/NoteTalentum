...
import es.danie.noteapp.model.Notes;
...
public class NotesListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NoteListFragment noteListFragment = (NoteListFragment) getSupportFragmentManager().findFragmentById(R.id.fragment_notelist);

        for (int i = 0; i < 20; i++) {
            Note note = new Note("Note"+ i);
            note.setText("Noticias super importantes: " + i);
